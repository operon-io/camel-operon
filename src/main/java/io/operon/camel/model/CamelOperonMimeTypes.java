...
public class CamelOperonMimeTypes {
	...
	public static final String APPLICATION_JAVA = "application/java"; // true Java types, e.g. ArrayType --> ArrayList, ObjectType --> LinkedHashMap, NullType --> null, etc.
	public static final String APPLICATION_JAVA_OPERON = "application/java-operon"; // Java Operon-types, e.g. ArrayType, ObjectType, etc.
