 ...
 * 
 */
public class CamelOperonLanguage14Test extends CamelTestSupport {
    ...
    public void testOperonExpr() throws Exception {
        ...
        mock.expectedBodiesReceived("\"BARBAZ\"");
            ...
            public void configure() {
                from("direct://start")
                    ...
                    .setBody().language("operon", 
                        "Select: 123 -> call:camel:{params: {uri: \"direct:foo\", readAs: \"String\", headers: {bar: \"barbaz\"}}} => upperCase()")
                    .to("mock:result")
                ;
